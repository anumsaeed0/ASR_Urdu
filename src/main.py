...
def main():
    ...
    train_parser.add_argument("--language", type=str, default='ur_pk', help="Language selection, e.g., 'ur_pk' or 'ur'")
    ...
    train_parser.add_argument("--output_dir", type=str, default="./whisper-ur-LoRA", help="Where to save the LoRA weights and processor")
    ...
    train_parser.add_argument("--auth_token", type=str, default="", help="Huggingface authentication token for specific datasets like CommonVoice")
    ...
    eval_parser.add_argument("--language", type=str, default='ur_pk', help="Language selection, e.g., 'ur_pk' or 'ur'")
    eval_parser.add_argument("--batch_size", type=int, default=4)
    eval_parser.add_argument("--model_dir", type=str, default="./whisper-ur-LoRA", help="Directory containing the saved model")
    ...
    eval_parser.add_argument("--auth_token", type=str, default="", help="Huggingface authentication token for specific datasets like CommonVoice")
